angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/_triggers.html',
    ...
    "<div ng-repeat=\"build in buildsByOutputImage[(trigger.imageChangeParams.from | imageObjectRef : namespace)] | orderObjectsByDate track by (build | uid)\" ng-if=\"!isBuildHidden(build)\" class=\"build animate-repeat osc-object\" kind=\"Build\" resource=\"build\">\n" +
    "\n" +
  ...
  $templateCache.put('views/directives/build-pipeline.html',
    ...
    "</div>\n" +
    "<div ng-if=\"build | buildLogURL\" class=\"small\"><a ng-href=\"{{build | buildLogURL}}\">View Log</a></div>\n" +
    "\n" +
    "<div flex></div>\n" +
    "</div>\n" +
  ...
  $templateCache.put('views/projects.html',
    ...
    "<delete-link class=\"fa-lg\" kind=\"Project\" resource-name=\"{{project.metadata.name}}\" project-name=\"{{project.metadata.name}}\" display-name=\"{{(project | displayName)}}\" type-name-to-confirm=\"true\" alerts=\"alerts\" button-only>\n" +
    "</delete-link>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
