...
function OverviewController(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y) {
var z = this, A = b("isIE")() || b("isEdge")(), B = 6e4, C = _.get(h, "ENABLE_TECH_PREVIEW_FEATURE.service_catalog_landing_page") && e.apiInfo({
...
var D, E, F = b("annotation"), G = b("buildConfigForBuild"), H = b("deploymentIsInProgress"), I = b("getErrorDetails"), J = b("imageObjectRef"), K = b("isJenkinsPipelineStrategy"), L = b("isNewerResource"), M = b("label"), N = b("podTemplate"), O = {}, P = {}, Q = {}, R = z.state = {
alerts:{},
builds:{},
clusterQuotas:{},
...
R.alerts[a.name] = a.data;
}), d.clearAlerts(), z.state.breakpoint = l.getBreakpoint();
var S = _.throttle(function() {
var b = l.getBreakpoint();
z.state.breakpoint !== b && a.$evalAsync(function() {
z.state.breakpoint = b;
});
}, 50);
$(window).on("resize.overview", S), z.showGetStarted = !1, z.showLoading = !0, z.filterByOptions = [ {
id:"name",
label:"Name"
}, {
id:"label",
label:"Label"
} ], z.filterBy = o.getLabelSelector().isEmpty() ? "name" :"label", z.viewByOptions = [ {
id:"app",
label:"Application"
}, {
id:"resource",
...
R.expandAll = b && 1 === z.size, z.showGetStarted = b && a, z.showLoading = !b && a, z.everythingFiltered = !a && !z.filteredSize, z.hidePipelineOtherResources = "pipeline" === z.viewBy && (z.filterActive || _.isEmpty(z.pipelineBuildConfigs));
}, Y = function(a) {
...
z.filteredDeploymentConfigsByApp = Y(z.filteredDeploymentConfigs), z.filteredReplicationControllersByApp = Y(z.filteredReplicationControllers), z.filteredDeploymentsByApp = Y(z.filteredDeployments), z.filteredReplicaSetsByApp = Y(z.filteredReplicaSets), z.filteredStatefulSetsByApp = Y(z.filteredStatefulSets), z.filteredMonopodsByApp = Y(z.filteredMonopods), z.apps = _.union(_.keys(z.filteredDeploymentConfigsByApp), _.keys(z.filteredReplicationControllersByApp), _.keys(z.filteredDeploymentsByApp), _.keys(z.filteredReplicaSetsByApp), _.keys(z.filteredStatefulSetsByApp), _.keys(z.filteredMonopodsByApp)), f.sortAppNames(z.apps), aa();
}, ca = function() {
var a = _.filter(z.deploymentConfigs, function(a) {
var b = T(a);
return _.isEmpty(R.pipelinesByDeploymentConfig[b]);
});
z.deploymentConfigsNoPipeline = _.sortBy(a, "metadata.name"), z.pipelineViewHasOtherResources = !(_.isEmpty(z.deploymentConfigsNoPipeline) && _.isEmpty(z.vanillaReplicationControllers) && _.isEmpty(z.deployments) && _.isEmpty(z.vanillaReplicaSets) && _.isEmpty(z.statefulSets) && _.isEmpty(z.monopods));
}, da = function() {
z.disableFilter = "pipeline" === z.viewBy && _.isEmpty(z.pipelineBuildConfigs);
}, ea = function(a) {
...
z.filteredDeploymentConfigs = ha(z.deploymentConfigs), z.filteredReplicationControllers = ha(z.vanillaReplicationControllers), z.filteredDeployments = ha(z.deployments), z.filteredReplicaSets = ha(z.vanillaReplicaSets), z.filteredStatefulSets = ha(z.statefulSets), z.filteredMonopods = ha(z.monopods), z.filteredPipelineBuildConfigs = ha(z.pipelineBuildConfigs), z.filteredServiceInstances = ha(R.orderedServiceInstances), z.filterActive = ia(), ba(), X();
}, ka = c.project + "/overview/view-by";
z.viewBy = localStorage.getItem(ka) || "app", a.$watch(function() {
return z.viewBy;
}, function(a) {
localStorage.setItem(ka, a), da(), fa = "app" === z.viewBy ? [ "metadata.name", "metadata.labels.app" ] :[ "metadata.name" ], ja(), "pipeline" === z.viewBy ? o.setLabelSuggestions(P) :o.setLabelSuggestions(O);
...
var b = U(a);
return b ? la(a) ? [ a ] :_.get(z, [ "state", "podsByOwnerUID", b ], []) :[];
}, na = function(a, b) {
var c = U(a);
...
var b = T(a);
return b ? _.get(z, [ "replicationControllersByDeploymentConfig", b ]) :[];
};
z.getPreviousReplicationController = function(a) {
var b = sa(a);
...
_.each(z.deploymentConfigs, ta);
}, va = function(a) {
var b = U(a);
return b ? _.get(z, [ "replicaSetsByDeploymentUID", b ]) :{};
}, wa = function(a) {
...
_.each(z.deployments, wa);
}, ya = function() {
qa(z.replicationControllers), qa(z.replicaSets), qa(z.statefulSets), qa(z.monopods);
}, za = _.debounce(function() {
a.$evalAsync(function() {
ya(), ua(), xa();
});
}, 500), Aa = function(a) {
_.isEmpty(a) || (o.addLabelSuggestionsFromResources(a, O), "pipeline" !== z.viewBy && o.setLabelSuggestions(O));
}, Ba = function(a) {
_.isEmpty(a) || (o.addLabelSuggestionsFromResources(a, P), "pipeline" === z.viewBy && o.setLabelSuggestions(P));
}, Ca = function(a) {
return "Succeeded" !== a.status.phase && "Failed" !== a.status.phase && (!M(a, "openshift.io/deployer-pod-for.name") && (!F(a, "openshift.io/build.name") && "slave" !== M(a, "jenkins")));
}, Da = function() {
R.podsByOwnerUID = u.groupByOwnerUID(z.pods), z.monopods = _.filter(R.podsByOwnerUID[""], Ca);
}, Ea = function(a) {
if (_.get(a, "status.replicas")) return !0;
var b = F(a, "deploymentConfig");
return !b || H(a);
}, Fa = function(a) {
return F(a, "deploymentConfig");
}, Ga = function() {
if (z.deploymentConfigs && z.replicationControllers) {
var a = [];
z.replicationControllersByDeploymentConfig = {}, z.currentByDeploymentConfig = {}, Q = {};
var b = {}, c = {};
_.each(z.replicationControllers, function(d) {
var e = Fa(d) || "";
(!e || !z.deploymentConfigs[e] && _.get(d, "status.replicas")) && a.push(d);
var f = Q[e];
f && !L(d, f) || (Q[e] = d);
var g;
"Complete" === F(d, "deploymentStatus") && (g = b[e], g && !L(d, g) || (b[e] = d)), Ea(d) && _.set(c, [ e, d.metadata.name ], d);
}), _.each(b, function(a, b) {
_.set(c, [ b, a.metadata.name ], a);
}), _.each(c, function(a, b) {
var c = j.sortByDeploymentVersion(a, !0);
z.replicationControllersByDeploymentConfig[b] = c, z.currentByDeploymentConfig[b] = _.head(c);
}), z.vanillaReplicationControllers = _.sortBy(a, "metadata.name"), ua();
}
}, Ha = function(a, b) {
if (_.get(a, "status.replicas")) return !0;
...
z.replicaSets && D && (z.replicaSetsByDeploymentUID = t.groupByControllerUID(z.replicaSets), z.currentByDeploymentUID = {}, _.each(z.replicaSetsByDeploymentUID, function(a, b) {
if (b) {
var c = D[b], d = _.filter(a, function(a) {
return Ha(a, c);
}), e = j.sortByRevision(d);
z.replicaSetsByDeploymentUID[b] = e, z.currentByDeploymentUID[b] = _.head(e);
}
}), z.vanillaReplicaSets = _.sortBy(z.replicaSetsByDeploymentUID[""], "metadata.name"), xa());
}, Ja = {}, Ka = function(a) {
...
var a = y.groupByService(z.routes, !0);
R.routesByService = _.mapValues(a, y.sortRoutesByScore), aa();
}, Na = function() {
R.hpaByResource = k.groupHPAs(z.horizontalPodAutoscalers);
}, Oa = function(a) {
var b = G(a), c = z.buildConfigs[b];
if (c) {
z.recentPipelinesByBuildConfig[b] = z.recentPipelinesByBuildConfig[b] || [], z.recentPipelinesByBuildConfig[b].push(a);
...
Pa = g.groupBuildConfigsByOutputImage(z.buildConfigs);
}, Ra = function(a) {
var b = U(a);
...
var a = [];
z.deploymentConfigsByPipeline = {}, R.pipelinesByDeploymentConfig = {}, _.each(z.buildConfigs, function(b) {
if (K(b)) {
a.push(b);
var c = g.usesDeploymentConfigs(b), d = T(b);
_.set(z, [ "deploymentConfigsByPipeline", d ], c), _.each(c, function(a) {
R.pipelinesByDeploymentConfig[a] = R.pipelinesByDeploymentConfig[a] || [], R.pipelinesByDeploymentConfig[a].push(b);
});
}
}), z.pipelineBuildConfigs = _.sortBy(a, "metadata.name"), ca(), Ba(z.pipelineBuildConfigs), da();
}, Va = function() {
R.buildConfigsByObjectUID = {}, _.each(z.deploymentConfigs, function(a) {
...
_.each(z.deploymentConfigs, Sa);
}, Ya = function() {
if (R.builds && z.buildConfigs) {
z.recentPipelinesByBuildConfig = {}, R.recentBuildsByBuildConfig = {}, R.recentPipelinesByDeploymentConfig = {};
var a = {};
_.each(g.interestingBuilds(R.builds), function(b) {
var c = G(b);
K(b) ? Oa(b) :(a[c] = a[c] || [], a[c].push(b));
}), z.recentPipelinesByBuildConfig = _.mapValues(z.recentPipelinesByBuildConfig, function(a) {
...
x.setGenericQuotaWarning(R.quotas, R.clusterQuotaData, c.project, R.alerts);
};
...
a !== b && (z.clearFilter(), ja());
}), o.onActiveFiltersChanged(function() {
a.$evalAsync(ja);
}), z.startBuild = R.startBuild = function(a) {
var b = K(a) ? "pipeline" :"build";
g.startBuild(a.metadata.name, {
namespace:a.metadata.namespace
}).then(function(c) {
var d, e = F(c, "buildNumber"), f = r.resourceURL(c);
d = e ? a.metadata.name + " #" + e :c.metadata.name, s.addNotification({
type:"success",
message:_.capitalize(b) + " " + d + " successfully created.",
links:[ {
href:f,
label:"View " + _.capitalize(b)
} ]
});
}, function(a) {
s.addNotification({
type:"error",
message:"An error occurred while starting the " + b + ".",
details:I(a)
});
});
};
...
return _.get(R.serviceClasses, [ a.spec.serviceClassName, "osbMetadata", "displayName" ]) || a.spec.serviceClassName;
}, function(a) {
return _.get(a, "metadata.name", "");
}))) :void (R.bindableServiceInstances = null);
}, ab = [];
v.get(c.project).then(_.spread(function(b, c) {
R.project = a.project = b, R.context = c;
var d = function() {
z.pods && m.fetchReferencedImageStreamImages(z.pods, R.imagesByDockerReference, R.imageStreamImageRefByDockerReference, c);
};
ab.push(i.watch("pods", c, function(a) {
z.pods = a.by("metadata.name"), Da(), d(), za(), Ka(z.monopods), qa(z.monopods), Aa(z.monopods), ja(), p.log("pods (subscribe)", z.pods);
})), ab.push(i.watch("replicationcontrollers", c, function(a) {
z.replicationControllers = a.by("metadata.name"), Ga(), Ka(z.vanillaReplicationControllers), Ka(z.monopods), qa(z.vanillaReplicationControllers), Aa(z.vanillaReplicationControllers), ja(), p.log("replicationcontrollers (subscribe)", z.replicationControllers);
})), ab.push(i.watch("deploymentconfigs", c, function(a) {
z.deploymentConfigs = a.by("metadata.name"), Ga(), Ka(z.deploymentConfigs), Ka(z.vanillaReplicationControllers), Aa(z.deploymentConfigs), xa(), Wa(), Xa(), ja(), p.log("deploymentconfigs (subscribe)", z.deploymentConfigs);
})), ab.push(i.watch({
group:"extensions",
resource:"replicasets"
}, c, function(a) {
z.replicaSets = a.by("metadata.name"), Ia(), Ka(z.vanillaReplicaSets), Ka(z.monopods), qa(z.vanillaReplicaSets), Aa(z.vanillaReplicaSets), ja(), p.log("replicasets (subscribe)", z.replicaSets);
})), ab.push(i.watch({
group:"extensions",
resource:"deployments"
}, c, function(a) {
D = a.by("metadata.uid"), z.deployments = _.sortBy(D, "metadata.name"), Ia(), Ka(z.deployments), Ka(z.vanillaReplicaSets), Aa(z.deployments), ja(), p.log("deployments (subscribe)", z.deploymentsByUID);
...
z.statefulSets = a.by("metadata.name"), Ka(z.statefulSets), Ka(z.monopods), qa(z.statefulSets), Aa(z.statefulSets), ja(), p.log("statefulsets (subscribe)", z.statefulSets);
}, {
poll:A,
pollInterval:B
...
z.routes = a.by("metadata.name"), Ma(), p.log("routes (subscribe)", z.routes);
}, {
poll:A,
pollInterval:B
})), ab.push(i.watch("buildConfigs", c, function(a) {
z.buildConfigs = a.by("metadata.name"), Qa(), Wa(), Ya(), ja(), p.log("buildconfigs (subscribe)", z.buildConfigs);
}, {
poll:A,
pollInterval:B
})), ab.push(i.watch({
...
z.horizontalPodAutoscalers = a.by("metadata.name"), Na(), p.log("autoscalers (subscribe)", z.horizontalPodAutoscalers);
}, {
poll:A,
pollInterval:B
})), ab.push(i.watch("imagestreams", c, function(a) {
E = a.by("metadata.name"), m.buildDockerRefMapForImageStreams(E, R.imageStreamImageRefByDockerReference), d(), p.log("imagestreams (subscribe)", E);
}, {
poll:A,
pollInterval:B
...
R.bindings = a.by("metadata.name"), z.bindingsByInstanceRef = _.groupBy(R.bindings, "spec.instanceRef.name"), $a(c);
}, {
poll:A,
pollInterval:B
...
R.serviceClasses = a.by("metadata.name"), _a(), ja();
});
...
i.unwatchAll(ab), $(window).off("resize.overview", S);
});
}));
}
...
} ]), angular.module("openshiftConsole").controller("DeploymentsController", [ "$scope", "$filter", "$routeParams", "AlertMessageService", "DataService", "DeploymentsService", "LabelFilter", "Logger", "OwnerReferencesService", "ProjectsService", function(a, b, c, d, e, f, g, h, i, j) {
...
k && l && (a.replicaSetsByDeploymentUID = i.groupByControllerUID(k), a.unfilteredReplicaSets = _.get(a, [ "replicaSetsByDeploymentUID", "" ], {}), g.addLabelSuggestionsFromResources(a.unfilteredReplicaSets, a.labelSuggestions), g.setLabelSuggestions(a.labelSuggestions), a.replicaSets = g.getLabelSelector().select(a.unfilteredReplicaSets), a.latestReplicaSetByDeploymentUID = {}, _.each(a.replicaSetsByDeploymentUID, function(b, c) {
c && (a.latestReplicaSetByDeploymentUID[c] = f.getActiveReplicaSet(b, l[c]));
}));
}, o = [];
...
k = b.by("metadata.name"), n(), h.log("replicasets (subscribe)", a.replicaSets);
...
l = a.unfilteredDeployments = b.by("metadata.uid"), g.addLabelSuggestionsFromResources(a.unfilteredDeployments, a.labelSuggestions), g.setLabelSuggestions(a.labelSuggestions), a.deployments = g.getLabelSelector().select(a.unfilteredDeployments), n(), h.log("deployments (subscribe)", a.unfilteredDeployments);
...
n.get(c.project).then(_.spread(function(d, k) {
a.project = d, a.projectContext = k;
var n, w = {}, x = function() {
h.getHPAWarnings(a.deployment, a.autoscalers, w, d).then(function(b) {
a.hpaWarnings = b;
});
};
e.get({
...
a.loaded = !0, a.deployment = d, x(), a.saveEnvVars = function() {
g.compact(a.updatedDeployment), n = e.update({
group:"extensions",
resource:"deployments"
}, c.deployment, a.updatedDeployment, k), n.then(function() {
...
a.updatedDeployment = g.copyAndNormalize(a.deployment), a.forms.deploymentEnvVars.$setPristine(), q = !1;
}, v.push(e.watchObject({
group:"extensions",
resource:"deployments"
...
var d = a.deployment;
a.deployment = b, a.updatingPausedState = !1, x(), r(b, d), n ? n["finally"](function() {
r(b, d);
}) :r(b, d), i.fetchReferencedImageStreamImages([ b.spec.template ], a.imagesByDockerReference, p, k);
})), v.push(e.watch({
group:"extensions",
resource:"replicasets"
}, k, function(b) {
var c = b.by("metadata.name");
c = l.filterForController(c, d), a.inProgressDeployment = _.chain(c).filter("status.replicas").size() > 1, a.replicaSetsForDeployment = f.sortByRevision(c);
}));
}, function(c) {
a.loaded = !0, a.alerts.load = {
type:"error",
...
}), v.push(e.watch("imagestreams", k, function(b) {
var c = b.by("metadata.name");
i.buildDockerRefMapForImageStreams(c, p), a.deployment && i.fetchReferencedImageStreamImages([ a.deployment.spec.template ], a.imagesByDockerReference, p, k), m.log("imagestreams (subscribe)", a.imageStreams);
})), v.push(e.watch({
group:"autoscaling",
resource:"horizontalpodautoscalers",
version:"v1"
}, k, function(b) {
a.autoscalers = h.filterHPA(b.by("metadata.name"), "Deployment", c.deployment), x();
})), v.push(e.watch("builds", k, function(b) {
...
o.removeVolume(a.deployment, b, k);
};
d.then(e);
}, a.$on("$destroy", function() {
e.unwatchAll(v);
...
a.valueFromObjects = [], o.get(c.project).then(_.spread(function(d, e) {
function l() {
q.getLabelSelector().isEmpty() || !$.isEmptyObject(a.deployments) || $.isEmptyObject(a.unfilteredDeployments) ? delete a.alerts.deployments :a.alerts.deployments = {
type:"warning",
details:"The active filters are hiding all deployments."
};
}
...
var o, D = {}, E = function() {
i.getHPAWarnings(a.deploymentConfig, a.autoscalers, D, d).then(function(b) {
a.hpaWarnings = b;
});
};
...
a.updatedDeploymentConfig = h.copyAndNormalize(a.deploymentConfig), a.forms.dcEnvVars.$setPristine(), v = !1;
}, A.push(f.watchObject("deploymentconfigs", c.deploymentconfig, e, function(b, c) {
"DELETED" === c && (a.alerts.deleted = {
type:"warning",
message:"This deployment configuration has been deleted."
});
var d = a.deploymentConfig;
a.deploymentConfig = b, a.updatingPausedState = !1, E(), o ? o["finally"](function() {
w(b, d);
}) :w(b, d), j.fetchReferencedImageStreamImages([ b.spec.template ], a.imagesByDockerReference, s, e);
}));
}, function(c) {
a.loaded = !0, a.alerts.load = {
type:"error",
...
}), A.push(f.watch("replicationcontrollers", e, function(d, e, f) {
...
a.deployments = q.getLabelSelector().select(a.unfilteredDeployments), a.orderedDeployments = t(a.deployments, !0), a.deploymentInProgress = !!_.size(a.deploymentConfigDeploymentsInProgress[h]), a.mostRecent = u(a.unfilteredDeployments), l(), q.addLabelSuggestionsFromResources(a.unfilteredDeployments, a.labelSuggestions), q.setLabelSuggestions(a.labelSuggestions);
}, {
http:{
params:{
labelSelector:r("deploymentConfig") + "=" + a.deploymentConfigName
}
}
...
}), A.push(f.watch("imagestreams", e, function(b) {
var c = b.by("metadata.name");
j.buildDockerRefMapForImageStreams(c, s), a.deploymentConfig && j.fetchReferencedImageStreamImages([ a.deploymentConfig.spec.template ], a.imagesByDockerReference, s, e), n.log("imagestreams (subscribe)", a.imageStreams);
})), A.push(f.watch("builds", e, function(b) {
a.builds = b.by("metadata.name"), n.log("builds (subscribe)", a.builds);
})), A.push(f.watch({
group:"autoscaling",
resource:"horizontalpodautoscalers",
version:"v1"
}, e, function(b) {
a.autoscalers = i.filterHPA(b.by("metadata.name"), "DeploymentConfig", c.deploymentconfig), E();
})), q.onActiveFiltersChanged(function(b) {
a.$apply(function() {
a.deployments = b.select(a.unfilteredDeployments), a.orderedDeployments = t(a.deployments, !0), l();
});
...
a.removeVolume = function(b) {
var c;
c = F() ? "This will remove the volume from the deployment config and trigger a new deployment." :"This will remove the volume from the deployment config.", b.persistentVolumeClaim ? c += " It will not delete the persistent volume claim." :b.secret ? c += " It will not delete the secret." :b.configMap && (c += " It will not delete the config map.");
var d = k.confirm({
message:"Remove volume " + b.name + "?",
details:c,
okButtonText:"Remove",
...
p.removeVolume(a.deploymentConfig, b, e);
};
d.then(f);
}, a.$on("$destroy", function() {
f.unwatchAll(A);
...
var u = !1, v = b("annotation"), w = b("humanizeKind")(t);
switch (t) {
case "ReplicaSet":
a.resource = {
group:"extensions",
...
var x = {};
a.projectName = c.project, a.kind = t, a.replicaSet = null, a.deploymentConfig = null, a.deploymentConfigMissing = !1, a.imagesByDockerReference = {}, a.builds = {}, a.alerts = {}, a.renderOptions = a.renderOptions || {}, a.renderOptions.hideFilterWidget = !0, a.forms = {}, a.logOptions = {}, d.getAlerts().forEach(function(b) {
a.alerts[b.name] = b.data;
}), d.clearAlerts();
var y = [];
...
var z, A = b("deploymentStatus"), B = function(b) {
a.logCanRun = !_.includes([ "New", "Pending" ], A(b));
}, C = !1, D = function(c, d) {
if (!C) {
...
a.saveEnvVars = function() {
i.compact(a.updatedReplicaSet), z = g.update(a.resource, c.replicaSet, a.updatedReplicaSet, a.projectContext), z.then(function() {
a.alerts.saveEnvSuccess = {
type:"success",
...
a.updatedReplicaSet = i.copyAndNormalize(a.replicaSet), a.forms.envForm.$setPristine(), C = !1;
};
var E = b("isIE")() || b("isEdge")(), F = b("orderByDisplayName"), G = b("getErrorDetails"), H = function(b, c) {
a.alerts["from-value-objects"] = {
type:"error",
message:b,
details:c
...
a.valueFromObjects = [], q.get(c.project).then(_.spread(function(d, i) {
a.project = d, a.projectContext = i, g.list("configmaps", i, null, {
errorNotification:!1
}).then(function(b) {
I = F(b.by("metadata.name")), a.valueFromObjects = I.concat(J);
}, function(a) {
403 !== a.code && H("Could not load config maps", G(a));
}), g.list("secrets", i, null, {
errorNotification:!1
}).then(function(b) {
J = F(b.by("metadata.name")), a.valueFromObjects = J.concat(I);
}, function(a) {
...
return b.covers(e);
}), a.deployment ? (a.healthCheckURL = o.healthCheckURL(c.project, "Deployment", a.deployment.metadata.name, "extensions"), y.push(g.watchObject({
group:"extensions",
resource:"deployments"
...
r.removeVolume(a.replicaSet, c, i);
};
e.then(f);
}, a.$on("$destroy", function() {
g.unwatchAll(y);
...
} ]), angular.module("openshiftConsole").controller("StatefulSetsController", [ "$scope", "$routeParams", "AlertMessageService", "DataService", "ProjectsService", "LabelFilter", "PodsService", function(a, b, c, d, e, f, g) {
...
a.pods = b.by("metadata.name"), a.podsByOwnerUID = g.groupByOwnerUID(a.pods);
...
} ]), angular.module("openshiftConsole").controller("StatefulSetController", [ "$filter", "$scope", "$routeParams", "AlertMessageService", "BreadcrumbsService", "DataService", "EnvironmentService", "MetricsService", "ProjectsService", "PodsService", function(a, b, c, d, e, f, g, h, i, j) {
...
l = c, f.get(n, b.statefulSetName, c).then(function(d) {
angular.extend(b, {
statefulSet:k(d),
project:a,
projectContext:c,
...
scale:function() {}
}), m.push(f.watchObject(n, b.statefulSetName, c, function(a) {
angular.extend(b, {
...
title:"Create Secret"
} ], k.get(c.project).then(_.spread(function(f, g) {
return d.project = f, d.context = g, d.breadcrumbs[0].title = a("displayName")(f), h.canI("secrets", "create", c.project) ? void (d.navigateBack = function() {
return c.then ? void b.url(c.then) :void e.history.back();
}) :void j.toErrorPage("You do not have authority to create secrets in project " + c.project + ".", "access_denied");
}));
...
}, i.startBuild = i.state.startBuild, i.canDeploy = function() {
