...
controller: [ "$scope", "$uibModal", "$filter", "$timeout", "APIService", function(e, t, n, r, a) {
var o = this;
o.isDeprecated = function(e) {
...
var t = o.webhookTriggers.length - 1;
r(function() {
e.$broadcast("triggerTypeFocus" + t);
});
};
var i = function(e) {
var t = _.filter(o.webhookTriggers, function(t) {
...
o.$onInit = function() {
e.namespace = o.namespace, e.type = o.type, o.secretsVersion = a.getPreferredVersion("secrets"), o.webhookTypesOptions = [ {
type: "github",
label: "GitHub"
}, {
type: "gitlab",
...
i(e);
}, o.missingInputError = function(e, t, n, r) {
var a = e + t;
return !!_.has(o.secretsForm, a) && ("triggerType" === e ? o.secretsForm[a].$touched && !n && r : "triggerSecretRef" === e && o.secretsForm[a].$touched && n && !r);
