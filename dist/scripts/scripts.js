...
return -1 === a ? this.resource :this.resource.substring(0, a);
...
return this.resource !== a ? !1 :1 === arguments.length ? !0 :this.group !== b ? !1 :2 === arguments.length ? !0 :this.version === c;
...
if (!a) return a;
var b = a.indexOf("/");
return -1 === b ? a.toLowerCase() :a.substring(0, b).toLowerCase() + a.substring(b);
}
function k(a, b) {
if (!a) return "";
var c = a;
...
return b ? o(b) ? (i.log("Too many websocket open or close events for resource/context in a short period", a, b), !0) :p(b) ? (i.log("Too many consecutive websocket close events for resource/context", a, b), !0) :!1 :!1;
};
var r = function(a) {
...
return -1 !== c && (b = b.substr(0, c)), b.split("#")[0];
}
};
...
function c() {}
return c.prototype.startBuild = function(c, d, e) {
var f = {
kind:"BuildRequest",
apiVersion:"v1",
metadata:{
...
return a ? a.metadata.deletionTimestamp ? !1 :!this.isPaused(a) :!1;
}, new c();
...
return a && c ? c === b("annotation")(a, "deploymentConfig") :!1;
...
function e(a, b) {
return a.min && a.max && a.start && a.end ? !(b.pod && a.samples < 2) :!1;
}
function f(a, b) {
...
"cpu/usage" === b.metric && (a.value = f(a, b)), /network\/rx|tx/.test(b.metric) && (a.value = g(a, b));
}), a) :void 0;
}
function i(a) {
...
f && (n += c(f));
}), j(e, g) || (o && o > m && q.push(r + " request total for all containers is less than pod minimum (" + d(h.min, e) + ")."), p && m > p && q.push(r + " request total for all containers is greater than pod maximum (" + d(h.max, e) + ").")), k(e, g) || (o && o > n && q.push(r + " limit total for all containers is less than pod minimum (" + d(h.min, e) + ")."), p && n > p && q.push(r + " limit total for all containers is greater than pod maximum (" + d(h.max, e) + ").")), q;
};
return {
...
return j("cpu", a) ? !0 :m("cpu", b, d) ? !0 :c.isRequestCalculated("cpu", d) && o(a, b, d);
}, q = function(a, b, c) {
...
function w(a) {
return "Succeeded" === a.status.phase || "Terminated" === a.status.phase || "Failed" === a.status.phase ? !1 :j(a, "openshift.io/deployer-pod-for.name") ? !1 :!f(a, "openshift.io/build.name");
}
function x() {
...
return d ? e(a, d) || b.isScalable(a, c) :!1;
...
return J(a.metadata.name) ? !1 :c ? b.deploymentConfigs ? b.deploymentConfigs[c] ? I(c) ? !1 :t[c] === a :!0 :!1 :!0;
};
var K = {};
...
return 0 === e("hashSize")(b.deploymentsByDeploymentConfig) ? !0 :!(1 !== e("hashSize")(b.deploymentsByDeploymentConfig) || !b.deploymentsByDeploymentConfig[""]);
}, f.onActiveFiltersChanged(function(a) {
b.$apply(function() {
...
return a.deploymentConfig ? a.deploymentConfig.metadata.deletionTimestamp ? !1 :!a.deploymentInProgress :!1;
...
return -1 !== l(a).toLowerCase().indexOf(b.toLowerCase());
}, g.onActiveFiltersChanged(function(a) {
b.$apply(function() {
...
e.push(a.tag);
}), a.imageSourceBuildFrom.imageStreams.push(d), b === a.imageSourceBuildFrom.namespace && c.metadata.name === a.imageSourceBuildFrom.imageStream && -1 === _.indexOf(e, a.imageSourceBuildFrom.tag) && e.push(a.imageSourceBuildFrom.tag), a.imageSourceBuildFrom.tags[d] = e, d === a.imageSourceOptions.pickedImageStream && _.isEmpty(e) && (a.imageSourceOptions.pickedTag = "");
...
c.status.tags && c.status.tags.forEach(function(a) {
e.push(a.tag);
}), a.buildFrom.imageStreams.push(d), b === a.builderImageStream.namespace && c.metadata.name === a.builderImageStream.imageStream && -1 === _.indexOf(e, a.builderImageStream.tag) && e.push(a.builderImageStream.tag), a.buildFrom.tags[d] = e, d === a.builderOptions.pickedImageStream && _.isEmpty(e) && (a.builderOptions.pickedTag = "");
...
if (-1 === [ "ReplicationController", "DeploymentConfig", "HorizontalPodAutoscaler" ].indexOf(c.kind)) return void i.toErrorPage("Autoscaling not supported for kind " + c.kind + ".");
...
if (!p) return void k.toErrorPage("Cannot create from template: a template name was not specified.");
...
title:p
} ], a.alerts = a.alerts || {}, e.getAlerts().forEach(function(b) {
a.alerts[b.name] = b.data;
}), e.clearAlerts();
var r = l("displayName"), s = l("humanize"), t = j("spec.template.spec.containers"), u = j("spec.strategy.sourceStrategy.from || spec.strategy.dockerStrategy.from || spec.strategy.customStrategy.from"), v = j("spec.output.to");
f.get(c.project).then(_.spread(function(b, e) {
function f(a) {
var b = [], c = t(a);
...
var g = m(u(b), a.projectName);
g && c.push({
name:g
});
var h = m(v(b), a.projectName);
h && (e[h] = !0);
}
"DeploymentConfig" === b.kind && (d = d.concat(f(b)));
...
function w() {
a.templateImages = j(a.template), a.template.labels = a.template.labels || {};
}
if (a.project = b, a.breadcrumbs[0].title = l("displayName")(b), a.projectDisplayName = function() {
return r(this.project) || this.projectName;
}, a.templateDisplayName = function() {
return r(this.template);
}, a.createFromTemplate = function() {
a.disableInputs = !0, d.create("processedtemplates", null, a.template, e).then(function(b) {
var f = {
...
i.clear(), i.add(f, h, function() {
var c = g.defer();
return d.batch(b.objects, e).then(function(b) {
var d = [], e = !1;
b.failure.length > 0 ? (e = !0, b.failure.forEach(function(a) {
d.push({
type:"error",
...
}), k.toNextSteps(c.name, a.projectName);
}, function(b) {
a.disableInputs = !1;
var c;
...
namespace:q || a.projectName
}).then(function(b) {
a.template = b, w();
}, function() {
k.toErrorPage("Cannot create from template: the specified template could not be retrieved.");
}); else {
if (a.template = o.getTemplate(), _.isEmpty(a.template)) {
var x = URI("error").query({
error:"not_found",
...
function r(a, b, c, d) {
return q(d, c, !0) ? !0 :-1 !== a.toLowerCase().indexOf(d) || b && -1 !== b.toLowerCase().indexOf(d);
}
function s(a, b, c) {
var e, f;
...
var f = function() {
return a.route.tls ? a.route.tls.termination && "passthrough" !== a.route.tls.termination ? !1 :a.route.tls.certificate || a.route.tls.key || a.route.tls.caCertificate || a.route.tls.destinationCACertificate :!1;
};
...
return $(c.target).closest("a").length > 0 ? void 0 :b.resource ? (a.setObject(b.resource, b.kind || b.resource.kind, {
source:b
}), !1) :void 0;
}), $(c).on("mousemove.oscobject", function() {
return b.resource || $(this).hasClass("osc-object-stacked") ? ($(".osc-object-hover").not(this).removeClass("osc-object-hover"), $(this).addClass("osc-object-hover"), !1) :void 0;
...
var f = e.id, g = e.data;
b = [ "dates" ], d[f] = [ e.label || f ];
var i = h.usageByMetric[f] = {
total:k(f)
}, j = _.last(g).value;
isNaN(j) && (j = 0), a.convert && (j = a.convert(j)), i.used = d3.round(j), i.total && (i.available = Math.max(i.total - i.used, 0)), angular.forEach(g, function(c) {
...
i.total && (m = {
type:"donut",
columns:[ [ "Used", i.used ], [ "Available", i.available ] ],
colors:{
Used:"#0088ce",
Available:"#d1d1d1"
}
}, s[f] ? s[f].load(m) :(l = w(a), l.data = m, c(function() {
s[f] = c3.generate(l);
})));
});
...
t[i] ? t[i].load(g) :(e = x(a), e.data = g, a.chartDataColors && (e.color = {
...
function m() {
return 60 * h.options.timeRange.value * 1e3;
}
function n(a, b, c) {
var d, e = {
metric:b.id,
bucketDuration:Math.floor(m() / 60) + "ms"
};
...
h.metricsError = {
status:a.status,
details:_.get(a, "data.errorMsg") || a.statusText || "Status code " + a.status
};
});
})["finally"](function() {
h.loaded = !0;
...
var r, s = {}, t = {}, u = b("resources.limits.memory"), v = b("resources.limits.cpu");
...
} ], h.loaded = !1, f.getMetricsURL().then(function(a) {
h.metricsURL = a;
}), h.options = {
rangeOptions:[ {
label:"Last hour",
...
}, h.options.timeRange = h.options.rangeOptions[0], h.usageByMetric = {}, h.anyUsageByMetric = function(a) {
return _.some(_.map(a.datasets, "id"), function(a) {
...
bindto:b,
onrendered:function() {
var c = h.usageByMetric[a.datasets[0].id].used;
e.updateDonutCenterText(b, c, a.units);
},
donut:{
label:{
show:!1
...
}), delete h.metricsError, q();
}, !0), r = a(q, 3e4, !1), h.$on("$destroy", function() {
r && (a.cancel(r), r = null), angular.forEach(s, function(a) {
a.destroy();
}), s = null, angular.forEach(t, function(a) {
a.destroy();
}), t = null;
});
}
...
a && c && (e = a >= c), a && d && (g = d >= a), b.form.amount.$setValidity("limitRangeMin", e), b.form.amount.$setValidity("limitRangeMax", g);
}, k = function() {
...
function e(a, b, d) {
return 0 !== a ? 1 === a ? void (c ? h.push(b) :h.push("one " + b)) :void h.push(a + " " + d) :void 0;
}
if (!a) return a;
d = d || 2, b = b || new Date();
...
reason:"Unknown",
message:"The state of this pod could not be obtained. This is typically due to an error communicating with the host of the pod."
}), a(e) && f.push({
reason:"Stuck",
message:"This pod has been stuck in the pending state for more than five minutes."
...
}), angular.module("openshiftConsole").filter("sentenceCase", function() {
return function(a) {
if (!a) return a;
var b = _.startCase(a).toLowerCase();
